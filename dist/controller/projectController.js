...
exports.updateProjectByOwner =
  exports.getProjectsByUser =
  exports.createCollaborator =
  exports.signUpCollaborator =
  exports.addCollaborator =
  exports.projectInvite =
...
async function createProject(req, res) {
  ...
  try {
    ...
    (_a = creator.projects) === null || _a === void 0
      ? void 0
      : _a.push({
...
async function addCollaborator(req, res) {
  ...
  try {
    ...
    if (existingUser) {
      ...
      (_b = existingUser.projects) === null || _b === void 0
        ? void 0
        : _b.push({
            projectId: projectID,
            projectName: project.projectName,
...
async function createCollaborator(req, res) {
  ...
  try {
    ...
    await project.save();
    const signToken = jsonwebtoken_1.default.sign({ _id: newUser._id.toString() }, secretKey, {
...
const updateProjectByOwner = async (req, res) => {
  ...
  try {
    const updatedProject = await projectSchema_1.default.findOneAndUpdate(
      { _id: id },
      { projectName: newName },
      { new: true },
    );
