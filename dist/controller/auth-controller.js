...
exports.redirectHandler =
  exports.redirect =
  exports.logout =
  exports.googleHandler =
  exports.login =
  exports.loginRedirect =
  exports.localAuth =
  exports.authFacebook =
  exports.getFacebookAuth =
  exports.loginPage =
    void 0;
...
async function loginPage(req, res) {
  try {
    ...
    if (regUser.password) {
      ...
      const token = jsonwebtoken_1.default.sign({ _id: regUser._id.toString() }, secretKey, {
...
async function loginRedirect(req, res) {
  try {
    const user = req.user;
    const token = jsonwebtoken_1.default.sign({ _id: user._id.toString() }, secretKey, {
      expiresIn: '72000000 seconds',
    });
    res.cookie('jwt', token);
    res.status(200).send({
