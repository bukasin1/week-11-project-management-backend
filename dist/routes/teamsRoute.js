...
router.post('/:projectID/createteam', auth_check_1.isLoggedIn, teams_controller_1.createTeam);
router.post('/:teamID/addmembertoteam', auth_check_1.isLoggedIn, teams_controller_1.addMemberToTeam);
router.put('/updateTeam/:teamID', projectAuth_1.projectAuth, teams_controller_2.updateMembers);
