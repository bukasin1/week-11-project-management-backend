...
router.post(
  '/:projectID/project-invite',
  auth_check_1.isLoggedIn,
  projectAuth_1.projectAuth,
  projectController_1.projectInvite,
);
...
router.post(
  ...
  auth_check_1.isLoggedIn,
  projectAuth_1.projectAuth,
  projectController_2.updateProjectByOwner,
);
