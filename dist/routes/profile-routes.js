...
router.get('/', auth_check_1.isLoggedIn, profile_controller_1.showProfile);
...
router.post('/:projectId/task', auth_check_1.isLoggedIn, file_uploads_1.upload, task_controller_1.createTask);
router.put('/:taskID', auth_check_1.isLoggedIn, projectAuth_1.projectAuth, file_uploads_1.upload, projectController_1.updateTask);
router.get('/getproject', auth_check_1.isLoggedIn, projectController_2.getProjectsByUser);
